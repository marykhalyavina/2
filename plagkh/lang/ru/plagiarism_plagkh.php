...
$string['privacy:metadata:plagiarism_plagkh_client:submittion_type'] = 'Тип отправки, отправленный в Copyleaks для идентификации.';
$string['privacy:metadata:plagiarism_plagkh_client:submittion_content'] = 'Содержание отправки, отправленное в Copyleaks для обработки сканирования.';