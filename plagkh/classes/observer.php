...
/**
 * observer.php - Moodle events handlers for plagkh plagiairsm plugin
...
/**
 * Moodle events handlers for plagkh plagiairsm plugin
 */
class plagiarism_plagkh_observer {
    ...
    public static function core_event_user_deletion(\core\event\user_deleted $event) {
        $eventhandler = new plagiarism_plagkh_eventshandler('user', 'deletion');
